...
export default function ProductCard({ imgUrl, title, description, priceRange }) {
  return (
    <div className="font-raleway p-2 text-white flex justify-center items-center">
      <div className="bg-white rounded-sm shadow-lg overflow-hidden max-w-sm">
        <img src={imgUrl || "/placeholder.svg"} alt={`${title} image`} className="w-full h-48 object-cover" />
